...
lista.on('click', '.modificar', function(){
    ...
    let id = datosCard.parent().find('.card').attr('id')
...
$('.botonUpdate').on('click',function(){
    ...
    $.post('http://localhost:300/vulcan/update', {id:id, name:name, origin:origin, destiny:destiny, description:description, date:date}, function(ruta){
